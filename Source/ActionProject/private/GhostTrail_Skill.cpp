...
// Sets default values
AGhostTrail_Skill::AGhostTrail_Skill()
{
	...
	ConstructorHelpers::FObjectFinder<UMaterialInstance> M_GhostTrail(TEXT("MaterialInstanceConstant'/Game/BluePrints/GhostTrail/MI_GhostTrail_Skill.MI_GhostTrail_Skill'"));
...
void AGhostTrail_Skill::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AGhostTrail_Skill::Tick(float DeltaTime)
{
...
void AGhostTrail_Skill::Init(USkeletalMeshComponent* Pawn)
{
