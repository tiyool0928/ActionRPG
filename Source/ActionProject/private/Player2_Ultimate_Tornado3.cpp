...
// Sets default values
APlayer2_Ultimate_Tornado3::APlayer2_Ultimate_Tornado3()
{
	...
	box1Comp->SetRelativeLocation(FVector(400, 0, 0));
	...
	box2Comp->SetRelativeLocation(FVector(-400, 0, 0));
	...
	ConstructorHelpers::FObjectFinder<UParticleSystem> TempEffect(TEXT("ParticleSystem'/Game/Particles/P_P2_Ult_Tornado3Effect.P_P2_Ult_Tornado3Effect'"));
...
void APlayer2_Ultimate_Tornado3::BeginPlay()
{
	Super::BeginPlay();
	box1Comp->OnComponentBeginOverlap.AddDynamic(this, &APlayer2_Ultimate_Tornado3::OnOverlapBegin);
	box2Comp->OnComponentBeginOverlap.AddDynamic(this, &APlayer2_Ultimate_Tornado3::OnOverlapBegin);
	GetWorld()->GetTimerManager().SetTimer(deathTimerHandle, this, &APlayer2_Ultimate_Tornado3::Die, 3.0f, false);
}

// Called every frame
void APlayer2_Ultimate_Tornado3::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void APlayer2_Ultimate_Tornado3::Die()
{
	Destroy();
}

void APlayer2_Ultimate_Tornado3::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
